...
const IMAGE_KEY_TO_DISPLAY_LABEL = {
  ...
  gangwondo: "강원도",
  gyunggido: "경기도(수원)", // 레이블을 더 명확하게 표시 (수원)
...
const Section5 = () => {
  ...
  return (
    <div className="w-full h-[1150px] sm:h-[1700px] bg-[#f7f7f7] text-[#202020] flex flex-col items-center justify-center px-4 sm:px-0">
      <div className="text-center text-[24px] sm:text-[40px] font-semibold ">
      ...
      <div className="w-full sm:w-[980px] h-[700px] sm:h-[1000px] shadow-lg rounded-3xl mt-20 flex flex-col items-center justify-between bg-white ">
        ...
        <div className="w-full h-full flex sm:flex-row flex-col  sm:px-[116px] items-center justify-center gap-5">
          ...
          <div className="sm:hidden w-full h-full relative ">
            ...
            {/* 경기도 */}
            <Image
              className={`absolute top-[28.97px] left-[101.79px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("gyunggido") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/gyunggido.svg"
              width={78.42}
              height={100.28}
              alt="경기도 지도"
            ...
            <div
              ...
              style={{ top: "48.97px", left: "103.79px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("gyunggido")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["gyunggido"]}
            </div>
            ...
            {/* 강원도 */}
            <Image
              className={`absolute left-[131.21px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("gangwondo") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/gangwondo.svg"
              width={140.37}
              height={119.24}
              alt="강원도 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "50px", left: "191.21px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("gangwondo")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["gangwondo"]}
            </div>
            ...
            {/* 경상북도 */}
            <Image
              className={`absolute left-[178.05px] top-[109.98px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("gyungsangbookdo") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/gyungsangbookdo.svg"
              width={106.9}
              height={116.44}
              alt="경상북도 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "159.98px", left: "218.05px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("gyungsangbookdo")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["gyungsangbookdo"]}
            </div>
            ...
            {/* 서울 */}
            <Image
              className={`absolute top-[69.26px] left-[117.63px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("seoul") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/seoul.svg"
              width={22.9}
              height={19.11}
              alt="서울 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "69.26px", left: "127.63px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("seoul")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["seoul"]}
            </div>
            ...
            {/* 충청북도 */}
            <Image
              className={`absolute top-[102.81px] left-[146.81px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("choongchungbookdo") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/choongchungbookdo.svg"
              width={83.22}
              height={91.33}
              alt="충청북도 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "122px", left: "156px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("choongchungbookdo")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["choongchungbookdo"]}
            </div>
            ...
            {/* 충청남도 */}
            <Image
              className={`absolute top-[115.69px] left-[76.38px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("choongchungnamdo") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/choongchungnamdo.svg"
              width={92.96}
              height={79.74}
              alt="충청남도 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "145px", left: "96px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("choongchungnamdo")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["choongchungnamdo"]}
            </div>
            ...
            {/* 대전 */}
            <Image
              className={`absolute top-[158.6px] left-[145.3px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("daejeon") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/daejeon.svg"
              width={17.24}
              height={22.48}
              alt="대전 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "158px", left: "145px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("daejeon")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["daejeon"]}
            </div>
            ...
            {/* 경상남도 */}
            <Image
              className={`absolute left-[164.06px] top-[202.62px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("gyungsangnamdo") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/gyungsangnamdo.svg"
              width={99.4}
              height={92.18}
              alt="경상남도 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "234px", left: "182px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("gyungsangnamdo")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["gyungsangnamdo"]}
            </div>
            ...
            {/* 울산 */}
            <Image
              className={`absolute top-[215.15px] left-[250.51px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("ulsan") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/ulsan.svg"
              width={27.97}
              height={29.2}
              alt="울산 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "215px", left: "250.51px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("ulsan")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["ulsan"]}
            </div>
            ...
            {/* 부산 */}
            <Image
              className={`absolute top-[230.78px] left-[238.8px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("busan") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/busan.svg"
              width={28.43}
              height={25.62}
              alt="부산 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "235px", left: "242px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("busan")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["busan"]}
            </div>
            ...
            {/* 전라북도 */}
            <Image
              className={`absolute left-[95.29px] bottom-[183.22px]  cursor-pointer transition-all duration-300 ease-in-out ${isSelected("junlabookdo") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/junlabookdo.svg"
              width={89.08}
              height={62.82}
              alt="전라북도 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "203px", left: "115px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("junlabookdo")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["junlabookdo"]}
            </div>
            ...
            {/* 전라남도 */}
            <Image
              className={`absolute top-[232.77px] left-[58.05px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("junlanamdo") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/junlanamdo.svg"
              width={120.86}
              height={111.76}
              alt="전라남도 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "270px", left: "100px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("junlanamdo")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["junlanamdo"]}
            </div>
            ...
            {/* 대구 */}
            <Image
              className={`absolute top-[194.01px] left-[211.87px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("daegu") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/daegu.svg"
              width={24.04}
              height={28.06}
              alt="대구 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "194px", left: "212px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("daegu")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["daegu"]}
            </div>
            ...
            {/* 광주 */}
            <Image
              className={`absolute top-[249.45px] left-[108.55px] cursor-pointer transition-all duration-300 ease-in-out ${isSelected("guangju") ? "border-2 border-red-500 z-20 shadow-xl scale-105" : ""}`}
              src="/guangju.svg"
              width={21.6}
              height={14.21}
              alt="광주 지도"
            ...
            <div
              className="absolute text-[10px] font-semibold text-gray-800 z-50 cursor-pointer"
              style={{ top: "249px", left: "108px" }} // 위치 조정 값 반영됨
              onClick={() => handleImageClick("guangju")} // 레이블 클릭 이벤트 추가
            >
              {IMAGE_KEY_TO_DISPLAY_LABEL["guangju"]}
            </div>
